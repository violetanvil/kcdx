...
-- (comp-09-pubsub-b) listens via kcdx.on("kcdx.comp-09-pubsub-a:<event>",
...
-- "<publisher>:event" stamp must resolve correctly when publish is called
...
-- name, so subscribers hear "kcdx.comp-09-pubsub-a:outfit_changed".
