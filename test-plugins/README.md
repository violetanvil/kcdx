...
| Last result | ⏳ PENDING (`CAP-31-outside-window` boot auto-pass; `CAP-31-reject` reports at save time — confirmed by the save gesture in `on_save`; `CAP-31-roundtrip` verified at the checkpoint launch after the save+reboot+load gesture) |
