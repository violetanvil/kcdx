...
| Engine status | LIVE-PENDING (kcdx.scan feature, the binder `src/lua_bind_scan.cpp` over `scan_engine::ResolveScan` — sub-1 `6cb1e98`, sub-2 `0cb2295`). No engine change; this row is the regression test only. Awaiting checkpoint launch. |
