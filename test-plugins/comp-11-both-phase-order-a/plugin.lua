...
-- "kcdx.comp-11-both-phase-order-a:phase_token" and one from B as
-- "kcdx.comp-11-both-phase-order-b:phase_token". The event NAME tells WHICH
...
kcdx.on("kcdx.comp-11-both-phase-order-a:phase_token", function(payload)
    record("a", payload)
end)
kcdx.on("kcdx.comp-11-both-phase-order-b:phase_token", function(payload)
    record("b", payload)
end)
