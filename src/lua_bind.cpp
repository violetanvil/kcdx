...
namespace kcdx::lua_bind_statement { void bind(lua_State* L); }
...
namespace kcdx::lua_bind_behavior { void bind(lua_State* L); }
...
void RegisterKcdxTable(lua_State* L) {
    ...
    LOG_INFO("LUA_BIND", "    after  kcdx::lua_bind_locator::bind");

    LOG_INFO("LUA_BIND", "    before kcdx::lua_bind_op::bind");
    kcdx::lua_bind_op::bind(L);
    LOG_INFO("LUA_BIND", "    after  kcdx::lua_bind_op::bind");

    LOG_INFO("LUA_BIND", "    before kcdx::lua_bind_functions::bind");
    kcdx::lua_bind_functions::bind(L);
    LOG_INFO("LUA_BIND", "    after  kcdx::lua_bind_functions::bind");

    LOG_INFO("LUA_BIND", "    before kcdx::lua_bind_hook::bind");
    kcdx::lua_bind_hook::bind(L);
    LOG_INFO("LUA_BIND", "    after  kcdx::lua_bind_hook::bind");

    LOG_INFO("LUA_BIND", "    before kcdx::lua_bind_statement::bind");
    kcdx::lua_bind_statement::bind(L);
    LOG_INFO("LUA_BIND", "    after  kcdx::lua_bind_statement::bind");
    ...
    LOG_INFO("LUA_BIND", "    before kcdx::lua_bind_behavior::bind");
    kcdx::lua_bind_behavior::bind(L);
    LOG_INFO("LUA_BIND", "    after  kcdx::lua_bind_behavior::bind");
