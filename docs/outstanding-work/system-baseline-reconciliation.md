...
| P4 Cycle 2 | Port all 7 repo `.ps1` guards (the 5 bespoke + the 2 Cycle-1-carved) → repo-local `.py`, each fire-verified for behavioral parity; settings.json fully Python | /execute | DONE-pending-commit (step-review PROCEED; 26 parity cases + independent re-verify; zero `.ps1` guard remains) |
