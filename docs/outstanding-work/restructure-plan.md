...
**Survival manifest fields — DEFERRED to Phase 9.1/9.2.** The `authored_against_game_version` / `on_changed_function` fields below are NOT built; they land in Phase 9.1/9.2 where they wire to the SQLite `hash_at` infra.
...
- [data/address-library/policy.md](../../data/address-library/policy.md) — per-version row model with hash-based auto-verification (Phase 9.1)
