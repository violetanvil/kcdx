...
| Step | Status | Commit |
|---|---|---|
| [4.1 [ENG] The 7-state verdict enum + the ceiling rule in survival_verify](step-1-eng-verdict-enum-ceiling.md) | NOT STARTED | — |
| [4.2 [ENG] The rank-1 observed-execution tier (hook-fire + pass-through; kcdx's own production call)](step-2-eng-rank1-observed-execution.md) | NOT STARTED | — |
| [4.3 [ENG] The rank-2 safe-read tier (cvar read + read-only vtable_base walk)](step-3-eng-rank2-safe-read.md) | NOT STARTED | — |
