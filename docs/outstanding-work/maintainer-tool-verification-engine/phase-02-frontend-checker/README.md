...
| [2.5 [FE] s02 install-set link surface (Bin-folder pick) + version-match gate + the layout + verify states](step-5-fe-s02-link-table.md) | NEEDS REWORK | FE:6e704ba (re-grounded to the install-set D30 + the s02-layout designs; rework owed) |
