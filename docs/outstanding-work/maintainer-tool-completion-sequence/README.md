...
trio). Immediate work resumes: **Step 4b — the general validator-message → teaching-copy translation
layer** (option 2c, deferred at KI-0024), then **Step 4 — KI-0020** (App.test.tsx s09 timing flake) and
**Step 5 — db-direct Phase 5 Docker**.
