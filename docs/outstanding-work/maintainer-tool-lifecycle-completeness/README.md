...
| Step | Status | Commit |
|---|---|---|
| [Phase 1 — Data-core: reconciliation skip + lifecycle detection](phase-01-data-core/README.md) | DONE | (landed) — 1.1 07fcf70 (close-intervals already-done skip, D41 fact 2) + 1.2 (landed) (lifecycle-completeness detection query, D41 fact 1). Both data-core steps green; full data-core 183 passed. |
| [Phase 2 — Backend: expose detection + classification](phase-02-backend/README.md) | NOT STARTED | — |
