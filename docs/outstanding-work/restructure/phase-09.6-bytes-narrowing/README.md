...
| [2 — `lua-api-surface.md` rule 4 / 4a rewrite](step-2-rule-update.md) | DONE | b1feadc — rules 4/4a already in final form (landed in the 2026-05-28 doc pass); no diff owed (row flipped with s3) |
| [3 — docs: tiered front door + `extensibility.md` + bytes tier-pointer](step-3-docs.md) | DONE | b1feadc |
| [4 — empowered C++ `kcdx::bytes::Write`/`TryWrite` wrapper + test](step-4-cpp-bytes-wrapper.md) | DONE | 69a781e — wrapper+test shipped in 9.3/9.5 work; cap-63 live-verified 2026-06-13 (verb landed as Write/TryWrite, not Replace) |
