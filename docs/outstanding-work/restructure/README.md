...
| [9.4 — kcdx.find{...} discovery + kcdx_dev_inspect console](phase-09.4-discovery/README.md) | DONE | 4 steps live-verified (0 98acc8e · 1 e83d1a4 · 2 af1a773 · 3 50dcbf8) + KI-0015 lean-materialization fix (40236a9) + KI-0016 un-indexed-scan fix (e39412b/008cd66) — whole-feature acceptance GREEN 2026-06-10: cap-98 4/4 + cap-99 6/6 PASS, `kcdx_dev_inspect` live, boot reaches `update tick` 250/273. `kcdx.find`/`kcdx_dev_inspect` are dev tools reading the DEV DB directly (user-decided 2026-06-10) |
| [9.5 — kcdx.behavior.* named-behavior catalog](phase-09.5-behaviors/README.md) | DONE | P1 DONE (s1 736481d · s2 7080dd0 · s3 08e2f2a · s4 5295397 · s5 1176742 · s6 eb57d1d · s7 783d7bb) · P2 DONE (s1 2e81f11 · s2 a8c75be) · P3 DONE (s1 d4b2f8f · s2 13e63ad + 80a0c39 swap-fix) — the two-tier named-behavior surface: registry core, Lua+C++ verbs, window law, edges+auto-order, the catalog loader + 6 shipped console-driven entries (all live-verified GREEN). outfit_swap (address-backed case study) deferred to TD-0014 (user-decided) |
| [9.6 — Lua-API rule update + tiered docs + C++ bytes wrapper (bytes narrowing STRUCK 2026-06-12)](phase-09.6-bytes-narrowing/README.md) | DONE | s1 STRUCK · s2 (rule 4/4a already landed) · s3 b1feadc · s4 (landed) cap-63 live-verified — bytes stays the general low-level primitive |
