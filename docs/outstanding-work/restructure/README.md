...
| [9.6 — Lua-API rule update + tiered docs + C++ bytes wrapper (bytes narrowing STRUCK 2026-06-12)](phase-09.6-bytes-narrowing/README.md) | DONE | s1 STRUCK · s2 b1feadc · s3 b1feadc · s4 69a781e cap-63 live-verified — bytes stays the general low-level primitive |
