...
| [9.5 — kcdx.behavior.* named-behavior catalog](phase-09.5-behaviors/README.md) | DONE | P1 DONE (s1 736481d · s2 7080dd0 · s3 08e2f2a · s4 5295397 · s5 1176742 · s6 eb57d1d · s7 783d7bb) · P2 DONE (s1 2e81f11 · s2 a8c75be) · P3 DONE (s1 d4b2f8f · s2 (landed)) — the two-tier named-behavior surface: registry core, Lua+C++ verbs, window law, edges+auto-order, the catalog loader + 6 shipped console-driven entries. outfit_swap (address-backed case study) deferred to TD-0014 (user-decided) |
