...
| Step | Status | Commit |
|---|---|---|
| [1 — `kcdxBehaviorInterface` + the value-handle model](step-1-interface-handles.md) | DONE | 2e81f11 |
| [2 — `Invoke` + the off-thread command queue](step-2-invoke-queue.md) | DONE | a8c75be |
