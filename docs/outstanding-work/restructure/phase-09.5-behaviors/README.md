...
| Phase | Status | Commit |
|---|---|---|
| [1 — core surface (probe · registry · boundary · window law · toggle · edges · auto-order)](phase-01-core-surface/README.md) | DONE | s1 736481d · s2 7080dd0 · s3 08e2f2a · s4 5295397 · s5 1176742 · s6 eb57d1d · s7 (landed) |
