...
**Active, not started.** kcdx takes total ownership of the engine's `CCryPak`
...
| Phase 2 — pak reader + unified index ([phase-02](phase-02-pak-reader-index/README.md)) | NOT STARTED | — |
